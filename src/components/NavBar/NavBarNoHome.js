...
import {HashLink as LinkRS} from "react-router-hash-link";
...
const HeaderNoHome = (props) => {
    ...
    return(
        ...
        <Nav scrollNavDown={scrollNavDown}>
            ...
            <NavMenu>
                ...
                <ExploreMenu>
                    <SubMenu>
                        ...
                        <LinkRS to="/#getstarted" smooth={true} duration={1000} spy={true} exact="true"><GetStarted sx={{transform: 'scale(1.2)', color: '#ba55d3'}}/></LinkRS>
            ...
            <LinkRS to="/#getstarted" smooth={true} duration={1000} spy={true} exact="true"><StyledButton whileHover={{scale: 1.1}} whileTap={{scale: 0.9}}>ابدأ الآن</StyledButton></LinkRS>
